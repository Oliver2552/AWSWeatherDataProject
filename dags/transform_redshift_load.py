...
transform_task = GlueJobOperator(
    ...
    script_location='newweatherdataproject-awsglueassetsbucket-sczjl3fqzy8g/scripts/transform.py',
    s3_bucket='newweatherdataproject-awsglueassetsbucket-sczjl3fqzy8g',  # S3 bucket where logs and local etl script will be uploaded
    aws_conn_id='AWS_CONN',  # You'll need to set up an AWS connection in Airflow
    region_name="us-east-1",
    iam_role_name='NewWeatherDataProject-RedshiftIamRole-PgcNTXusyYuI',
